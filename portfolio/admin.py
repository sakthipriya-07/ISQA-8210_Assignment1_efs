...
class MutualList(admin.ModelAdmin):
    list_display = (
        'customer', 'fund_category', 'description', 'direct_plan', 'regular_plan', 'difference', 'acquired_date')
    list_filter = ('customer', 'fund_category')
    search_fields = ('customer', 'fund_category')
    ordering = ['customer']
