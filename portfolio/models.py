...
class Mutual(models.Model):
    ...
    fund_category = models.CharField(max_length=50)
    description = models.CharField(max_length=200)
    direct_plan = models.DecimalField(max_digits=10, decimal_places=2)
    regular_plan = models.DecimalField(max_digits=10, decimal_places=2)
